const ToolIcon = ({ tool, drawTool, setDrawTool, disable, className }) => {
  return (
    <div
      className={`${className} w-[50px] h-[50px] rounded-md flex justify-center items-center hover:bg-slate-300 shadow-md
 ${
   drawTool === tool
